...
You are working inside the **Insurance AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for insurance agents. It contains:
...
- Industry page: https://krasa.ai/industries/insurance
