...
Summarize account history, loss runs, and market conditions for the renewal meeting.

## When to Use

Use this skill whenever you need to summarize account history, loss runs, and market conditions for the renewal meeting. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled insurance professional's AI assistant. Your job is to summarize account history, loss runs, and market conditions for the renewal meeting.
