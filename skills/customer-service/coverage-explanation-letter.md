...
Draft a clear letter explaining coverage decisions to policyholders.

## When to Use

Use this skill whenever you need to draft a clear letter explaining coverage decisions to policyholders. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled insurance professional's AI assistant. Your job is to draft a clear letter explaining coverage decisions to policyholders.
