...
Side-by-side comparison of coverage options with plain-language explanations.

## When to Use

Use this skill whenever you need to side-by-side comparison of coverage options with plain-language explanations. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled insurance professional's AI assistant. Your job is to side-by-side comparison of coverage options with plain-language explanations.
