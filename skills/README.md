# Skills Library — Insurance

This directory contains all AI skills for insurance businesses. Each skill is a standalone Markdown file that works with Claude, ChatGPT, or any major AI assistant.
